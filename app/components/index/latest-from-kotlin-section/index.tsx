        ...
        <Section className="latest-from-kotlin-section">
            <Container>
                ...
                <div className="kto-offset-top-32">
                    <a href="https://blog.jetbrains.com/kotlin/2022/04/kotlin-1-6-20-released/" target="_blank" rel="noopener noreferrer" className="latest-from-kotlin-section__banner-link">
                        <picture>
                    ...
                    {newsData.map((news, index) => (
                        <div key={index} className="kto-col-3 kto-col-md-6 kto-col-sm-12">
                            ...
                            <h3 className={cn(textCn('rs-text-2'), 'kto-offset-top-8')}>
                                <a href={news.link} target="_blank" rel="noopener noreferrer" className={textCn('rs-link', {external: true})}>
                                    {news.title}
                                </a>
                            </h3>
                        </div>
